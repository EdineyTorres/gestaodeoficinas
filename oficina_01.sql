...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11/11/2021 às 13:32
...
--
-- Banco de dados: `oficina_01`
--

-- --------------------------------------------------------

--
-- Estrutura para tabela `agendamentos_sac`
--

CREATE TABLE `agendamentos_sac` (
  `id` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `agendamentos_sac`
--

INSERT INTO `agendamentos_sac` (`id`, `nome`, `descricao`, `local`, `data`, `hora`, `placa`, `cliente`, `tipo_pessoa`, `atendente`, `status`) VALUES
(1, 'Orçamento Honda Civic', 'Verificar Peças', 'Oficina', '2021-10-25', '14:00:00', 'fff-2222', '041.150.016-31', 'Pessoa Física', '888.888.888-88', 'Agendada'),
(2, 'ediney', 'Montagem', 'Oficina', '2021-10-26', '13:04:00', 'LLQ-7223', '041.150.016-31', 'Pessoa Física', '999.999.999-99', 'Concluida');

-- --------------------------------------------------------

--
-- Estrutura para tabela `atendentes_sac`
--

CREATE TABLE `atendentes_sac` (
  `id` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `atendentes_sac`
--

INSERT INTO `atendentes_sac` (`id`, `nome`, `email`, `cpf`, `foto`) VALUES
(5, 'admin', 'admin@guariglia.com', '999.999.999-99', ''),
(9, 'teste3', 'nextmegamail@gmail.com', '777.777.777-77', '');

-- --------------------------------------------------------

--
-- Estrutura para tabela `cargos_sac`
--

CREATE TABLE `cargos_sac` (
  `id` int(11) NOT NULL,
  `nome` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Despejando dados para a tabela `cargos_sac`
--

INSERT INTO `cargos_sac` (`id`, `nome`) VALUES
(1, 'Administrador'),
(2, 'Atendente'),
(3, 'Mecânico'),
(4, 'Usuario');
...
--
-- Estrutura para tabela `categorias_sac`
--

CREATE TABLE `categorias_sac` (
  `id` int(11) NOT NULL,
  `nome` varchar(35) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Despejando dados para a tabela `categorias_sac`
--

INSERT INTO `categorias_sac` (`id`, `nome`) VALUES
(1, 'Caminhões'),
(2, 'Utilitários'),
(3, 'Automóveis'),
(4, 'Vans'),
...
--
-- Estrutura para tabela `chamados_sac`
--

CREATE TABLE `chamados_sac` (
  `id` int(11) NOT NULL,
  `placa` varchar(9) CHARACTER SET utf8mb4 NOT NULL,
  `veiculo` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
  `mecanico` varchar(40) CHARACTER SET utf8mb4 NOT NULL,
  `data_previsao` date NOT NULL,
  `os` varchar(4) CHARACTER SET utf8mb4 NOT NULL,
  `servico` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  `cpf_cliente` varchar(60) CHARACTER SET utf8mb4 NOT NULL,
  `atendente` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
...
--
-- Despejando dados para a tabela `chamados_sac`
--

INSERT INTO `chamados_sac` (`id`, `placa`, `veiculo`, `mecanico`, `data_previsao`, `os`, `servico`, `cpf_cliente`, `atendente`, `data_abertura`, `categoria`, `status`) VALUES
(1, 'ppp-9999', 'fiesta', '1', '2021-10-11', '001', '10', '041.150.016-31', '888.888.888-88', '2021-10-25', '3', 'Andamento');

-- --------------------------------------------------------

--
-- Estrutura para tabela `cidades_sac`
--

CREATE TABLE `cidades_sac` (
  `id` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `cidades_sac`
--

INSERT INTO `cidades_sac` (`id`, `nome`, `estados_id`) VALUES
(3, 'Brasiléia', 1),
(4, 'Bujari', 1),
(5, 'Capixaba', 1),
(6, 'Cruzeiro do Sul', 1),
...
--
-- Estrutura para tabela `clientes_sac`
--

CREATE TABLE `clientes_sac` (
  `id` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `clientes_sac`
--

INSERT INTO `clientes_sac` (`id`, `nome`, `cpf`, `rg`, `telefone`, `telefone2`, `email`, `endereco`, `cidade`, `uf`, `atendente`, `data`, `obs`, `tipo_pessoa`) VALUES
(1, 'Cliente Teste 3', '041.150.016-31', '', '(12) 99673-9830', '', 'teste3@teste.com', 'Rua Tenente Mesquita, 460', 'Caçapava', 'Alagoas', '888.888.888-88', '2021-10-25', '', 'Pessoa Física'),
(2, 'Cliente Teste 2', '935.786.608-68', '', '(12) 99628-2410', '', 'teste2@teste.com', 'Rua Doutor Odilon de Souza Miranda', 'Caçapava', 'Bahia', '888.888.888-88', '2021-10-25', '', 'Pessoa Física'),
(3, 'Cliente Teste 1', '777.777.777-77', '', '(12) 36556-000', '', 'teste1@teste.com', '470 RUA TENENTE MESQUITA', 'CACAPAVA', 'São Paulo', '999.999.999-99', '2021-10-26', '', 'Pessoa Física');

-- --------------------------------------------------------

--
-- Estrutura para tabela `documentos_sac`
--

CREATE TABLE `documentos_sac` (
...
--
-- Estrutura para tabela `estados_sac`
--

CREATE TABLE `estados_sac` (
  `id` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `estados_sac`
--

INSERT INTO `estados_sac` (`id`, `nome`, `sigla`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
--
-- Estrutura para tabela `historico_pag_sac`
--

CREATE TABLE `historico_pag_sac` (
  `id` int(11) NOT NULL,
  `tipo` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
  `valor` decimal(10,2) NOT NULL,
  `movimento` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  `descricao` varchar(300) CHARACTER SET utf8mb4 NOT NULL,
  `data` date NOT NULL,
  `placa` varchar(10) CHARACTER SET utf8mb4 NOT NULL,
  `categoria` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
  `atendente` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
  `cliente` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  `data_previsao` date NOT NULL,
  `os` varchar(4) CHARACTER SET utf8mb4 NOT NULL,
  `mecanico` varchar(50) CHARACTER SET utf8mb4 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Despejando dados para a tabela `historico_pag_sac`
--

INSERT INTO `historico_pag_sac` (`id`, `tipo`, `valor`, `movimento`, `descricao`, `data`, `placa`, `categoria`, `atendente`, `cliente`, `data_previsao`, `os`, `mecanico`) VALUES
(1, 'Combustível', '500.00', 'Saída', 'gggg', '2021-10-25', 'LPP-6H94', 'SERVIÇO', '888.888.888-88', '041.150.016-31', '2021-10-19', '001', '1'),
(2, 'Fornecedor de Baterias', '250.00', 'Saída', 'PAGO', '2021-10-26', 'LLQ-7223', 'SERVIÇO', '999.999.999-99', '041.150.016-31', '2021-10-19', '001', '1'),
(3, 'Óleo de Direção', '500.00', 'Saída', '', '2021-10-26', 'ppp-9999', 'CHAMADO', '999.999.999-99', '041.150.016-31', '2021-10-11', '001', '1');

-- --------------------------------------------------------

--
-- Estrutura para tabela `historico_sac`
--

CREATE TABLE `historico_sac` (
  `id` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `historico_sac`
--

INSERT INTO `historico_sac` (`id`, `titulo`, `obs`, `data`, `placa`, `categoria`, `atendente`, `cliente`) VALUES
(1, 'Verificado o motor', 'Motor com vazamento', '2021-10-25', 'LPP-6H94', 'SERVIÇO', '888.888.888-88', '041.150.016-31'),
(2, 'VERIFICAR GERENTE', 'GERENTE APROVOU', '2021-10-26', 'LLQ-7223', 'SERVIÇO', '999.999.999-99', '041.150.016-31'),
(3, 'TESTE', '', '2021-10-26', 'ppp-9999', 'CHAMADO', '999.999.999-99', '041.150.016-31');

-- --------------------------------------------------------

--
-- Estrutura para tabela `mecanicos_sac`
--

CREATE TABLE `mecanicos_sac` (
  `id` int(11) NOT NULL,
  `nome` varchar(35) NOT NULL,
...
--
-- Despejando dados para a tabela `mecanicos_sac`
--

INSERT INTO `mecanicos_sac` (`id`, `nome`, `representante`, `cpf`, `razao`, `telefone`, `email`, `endereco`, `usuario`, `data`, `obs`, `tipo_pessoa`) VALUES
(1, 'Mecânico Novo 01', '', '111.111.111-11', 'Mecanico Novo', '(11) 11111-1111', 'mecanico@mecanico', 'Teste', 'teste', '2021-10-25', 'Teste', 'Pessoa Física');

-- --------------------------------------------------------

--
-- Estrutura para tabela `servicos_sac`
--

CREATE TABLE `servicos_sac` (
  `id` int(11) NOT NULL,
  ...
  `mecanico` varchar(40) DEFAULT NULL,
...
--
-- Despejando dados para a tabela `servicos_sac`
--

INSERT INTO `servicos_sac` (`id`, `placa`, `veiculo`, `especie`, `tipo_acao`, `atendente`, `cliente`, `mecanico`, `data_previsao`, `os`, `data_abertura`, `status`, `tipo_pessoa`, `obs`) VALUES
(1, 'LPP-6H94', 'Gol', '10', '3', '888.888.888-88', '041.150.016-31', '1', '2021-10-19', '0002', '2021-10-25', 'Aberto', '', NULL),
(2, 'LLQ-7223', 'fiesta', '10', '3', '888.888.888-88', '041.150.016-31', '1', '2021-10-19', '0004', '2021-10-25', 'Concluído', '', NULL),
(3, 'OQJ-1120', 'Gol', '10', '3', '999.999.999-99', '777.777.777-77', '1', '2021-10-13', '0005', '2021-10-26', 'Aberto', '', NULL);

-- --------------------------------------------------------

--
-- Estrutura para tabela `tipos_pag_sac`
--

CREATE TABLE `tipos_pag_sac` (
  `id` int(11) NOT NULL,
  `nome` varchar(100) CHARACTER SET utf8mb4 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Despejando dados para a tabela `tipos_pag_sac`
--

INSERT INTO `tipos_pag_sac` (`id`, `nome`) VALUES
(1, 'Fornecedor de Baterias'),
(2, 'Borracheiro'),
(3, 'Lava Rápido'),
(4, 'Técnico em Módulos'),
(5, 'Combustível'),
(6, 'Óleo de Motor'),
(7, 'Óleo de Freio'),
(8, 'Óleo de Direção'),
(9, 'Técnico em Hodômetro');

-- --------------------------------------------------------

--
-- Estrutura para tabela `tipos_sac`
--

CREATE TABLE `tipos_sac` (
  `id` int(11) NOT NULL,
  `nome` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Despejando dados para a tabela `tipos_sac`
--

INSERT INTO `tipos_sac` (`id`, `nome`) VALUES
(1, 'Troca de Óleo'),
(2, 'Suspensão'),
(3, 'Motor'),
(4, 'Câmbio'),
...
--
-- Estrutura para tabela `usuarios_sac`
--

CREATE TABLE `usuarios_sac` (
  `id` int(11) NOT NULL,
  `nome` varchar(35) NOT NULL,
...
--
-- Despejando dados para a tabela `usuarios_sac`
--

INSERT INTO `usuarios_sac` (`id`, `nome`, `senha`, `email`, `cpf`, `cargo`, `obs`) VALUES
(1, 'admin', '1234', 'admin@guariglia.com', '999.999.999-99', 'Atendente', 'Teste'),
(3, 'teste', '1234', 'teste@gmail.com', '888.888.888-88', 'Atendente', 'sgsgg'),
(9, 'teste33', 'teste', 'nextmegamail@gmail.com', '777.777.777-77', 'Atendente', '');
...
--
-- Índices de tabela `agendamentos_sac`
--
ALTER TABLE `agendamentos_sac`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `atendentes_sac`
--
ALTER TABLE `atendentes_sac`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `cargos_sac`
--
ALTER TABLE `cargos_sac`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cargo_id` (`nome`);

--
-- Índices de tabela `categorias_sac`
--
ALTER TABLE `categorias_sac`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `chamados_sac`
--
ALTER TABLE `chamados_sac`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `cidades_sac`
--
ALTER TABLE `cidades_sac`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_cidades_estados1` (`estados_id`);

--
-- Índices de tabela `clientes_sac`
--
ALTER TABLE `clientes_sac`
  ADD PRIMARY KEY (`id`),
  ADD KEY `atendente` (`atendente`);

--
-- Índices de tabela `documentos_sac`
--
ALTER TABLE `documentos_sac`
  ADD PRIMARY KEY (`id_arq`);

--
-- Índices de tabela `estados_sac`
--
ALTER TABLE `estados_sac`
  ADD PRIMARY KEY (`id`,`sigla`),
  ADD UNIQUE KEY `sigla_UNIQUE` (`sigla`);

--
-- Índices de tabela `historico_pag_sac`
--
ALTER TABLE `historico_pag_sac`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `historico_sac`
--
ALTER TABLE `historico_sac`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `mecanicos_sac`
--
ALTER TABLE `mecanicos_sac`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `servicos_sac`
--
ALTER TABLE `servicos_sac`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `tipos_pag_sac`
--
ALTER TABLE `tipos_pag_sac`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `tipos_sac`
--
ALTER TABLE `tipos_sac`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `usuarios_sac`
--
ALTER TABLE `usuarios_sac`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de tabela `agendamentos_sac`
--
ALTER TABLE `agendamentos_sac`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `atendentes_sac`
--
ALTER TABLE `atendentes_sac`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `cargos_sac`
--
ALTER TABLE `cargos_sac`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `categorias_sac`
--
ALTER TABLE `categorias_sac`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `chamados_sac`
--
ALTER TABLE `chamados_sac`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `clientes_sac`
--
ALTER TABLE `clientes_sac`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `documentos_sac`
--
ALTER TABLE `documentos_sac`
  MODIFY `id_arq` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `historico_pag_sac`
--
ALTER TABLE `historico_pag_sac`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `historico_sac`
--
ALTER TABLE `historico_sac`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `mecanicos_sac`
--
ALTER TABLE `mecanicos_sac`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `servicos_sac`
--
ALTER TABLE `servicos_sac`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `tipos_pag_sac`
--
ALTER TABLE `tipos_pag_sac`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `tipos_sac`
--
ALTER TABLE `tipos_sac`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de tabela `usuarios_sac`
--
ALTER TABLE `usuarios_sac`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
-- Restrições para tabelas `cidades_sac`
--
ALTER TABLE `cidades_sac`
  ADD CONSTRAINT `fk_cidades_estados1` FOREIGN KEY (`estados_id`) REFERENCES `estados_sac` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Restrições para tabelas `clientes_sac`
--
ALTER TABLE `clientes_sac`
  ADD CONSTRAINT `clientes_sac_ibfk_1` FOREIGN KEY (`atendente`) REFERENCES `usuarios_sac` (`cpf`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Restrições para tabelas `usuarios_sac`
--
ALTER TABLE `usuarios_sac`
  ADD CONSTRAINT `cargo_fk` FOREIGN KEY (`cargo`) REFERENCES `cargos_sac` (`nome`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
